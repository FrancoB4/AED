...
terminó en el año 2000). Determinar si alguna de las obras fue creada en un año que se ingresa por teclado. Informar
la diferencia en años entre la obra más nueva y la más antigua. """
